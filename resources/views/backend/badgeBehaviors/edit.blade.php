            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="d-flex align-items-center">
                        <p class="mb-0">Edit Badge Rule</p>
                ...
                <div class="card-body">
                    ...
                    <form method="post" action="{{route('backend.badgeBehaviors.update',$badgeBehavior)}}" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select name="subject_id" class="form-control">
                                        ...
                                        @foreach($subjects as $subject)
                                            <option value="{{$subject->id}}" {{$badgeBehavior->subject->id == $subject->id ? 'selected' :''}}>{{$subject->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="badge_id" class="form-control">
                                        ...
                                        @foreach($badges as $badge)
                                            <option value="{{$badge->id}}" {{$badgeBehavior->badge->id == $badge->id ? 'selected' :''}}>{{$badge->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="rule_id" class="form-control">
                                        ...
                                        @foreach($behaviors as $rule)
                                            <option value="{{$rule->id}}" {{$badgeBehavior->behavior->id == $rule->id ? 'selected' :''}}>{{$rule->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>

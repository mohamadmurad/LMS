                ...
                <div class="">
                    <ul class="objectives list-group ">
                        @foreach($module->objectives as $obj)
                            <li class=" {{request()->objective->id == $obj->id ? 'active':''}}">
                                <a class="d-flex"
                                    ...
                                    <div class="icon">
                                        @if($obj->isSeen()->count()>0)
                                            <svg fill="#1F8354" class="_ufjrdd" viewBox="0 0 48 48" role="img"
                                                ...
                                                <title id="Completedd75e1050-e1de-4d77-d4f6-e07d1ea8e3e7">Completed</title>
                                                <path
                        ...
                        @if($module->exam)
                            ...
                            <li class=" ">
                                <a class="d-flex"
                                   href="{{route('student.exam.show',['module'=>$module,'exam'=>$module->exam])}}">
                                    <div class="icon">
                                        {{--                                    {{$module->exam->authSubmit->first()}}--}}
                                        @if($module->exam->authSubmit->first())
                                            <svg fill="#1F8354" class="_ufjrdd" viewBox="0 0 48 48" role="img"
                                                 aria-labelledby="Completedd75e1050-e1de-4d77-d4f6-e07d1ea8e3e7 Completedd75e1050-e1de-4d77-d4f6-e07d1ea8e3e7Desc"
                                                 xmlns="http://www.w3.org/2000/svg"
                                                 style="fill: rgb(54, 59, 66); height: 20px; width: 20px; margin-right: 12px;">
                                        ...
                                        @else
                                            <svg aria-hidden="true" class="_ufjrdd" viewBox="0 0 48 48" role="img" aria-labelledby="Quiz500a3ccf-7fb4-468b-8a48-70ca48f6a586 Quiz500a3ccf-7fb4-468b-8a48-70ca48f6a586Desc" xmlns="http://www.w3.org/2000/svg" style="fill: rgb(54, 59, 66); height: 20px; width: 20px; margin-right: 12px;"><title id="Quiz500a3ccf-7fb4-468b-8a48-70ca48f6a586">Quiz</title><path d="M24 47C11.3 47 1 36.7 1 24S11.3 1 24 1s23 10.3 23 23-10.3 23-23 23zm0-1.84c11.7 0 21.16-9.47 21.16-21.16C45.16 12.3 35.7 2.84 24 2.84 12.3 2.84 2.84 12.3 2.84 24c0 11.7 9.47 21.16 21.16 21.16zM21 17h10v2H21v-2zm0 6h10v2H21v-2zm0 6h10v2H21v-2zm-3-10c-.55 0-1-.45-1-1s.45-1 1-1 1 .45 1 1-.45 1-1 1zm0 6c-.55 0-1-.45-1-1s.45-1 1-1 1 .45 1 1-.45 1-1 1zm0 6c-.55 0-1-.45-1-1s.45-1 1-1 1 .45 1 1-.45 1-1 1zm-5-21h22v28H13V10zm2 2v24h18V12H15z" role="presentation"></path></svg>
                                        @endif

                                    </div>
                                    <div class="title">{{$module->exam->name}}</div>
                                </a>
                            </li>
                        @endif
